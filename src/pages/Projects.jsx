...
import { freelance, projects } from "../constants";
    ...
    return (
        <section className="max-container">
            ...
            <p className="text-slate-500 mt-2 leading-relaxed">
                I've successfully completed numerous freelance projects for a
                variety of clients. Here are a few of my favorites.
            </p>
            ...
            <p className="text-slate-500 mt-2 leading-relaxed">
                I've embarked on numerous projects throughout my career, but
